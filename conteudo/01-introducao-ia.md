...
- [Redes Neurais](03-redes-neurais.md)
- [Modelos de Linguagem](04-modelos-linguagem.md)
...
1. **Identificar IA no Cotidiano:** Liste 5 aplicações de IA que você usa no seu dia a dia e tente identificar se elas usam ML ou Deep Learning.
   - Dica: Pense em aplicativos no seu celular, serviços online que você usa, etc.

2. **Compreender a Hierarquia:** Desenhe um diagrama mostrando a relação entre IA, ML e DL, adicionando exemplos específicos em cada categoria.
...
- [Prompt Engineering: A Arte de Conversar com IA](02-prompt-engineering.md)
- [Explorando Recursos e Ferramentas de IA](../recursos/ferramentas.md)
